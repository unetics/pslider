		...
		<div class="ls-settings-contents">
			<table>
				...
				<tbody class="active">
					...
					<tr>
						<td>Slider width</td>
						<?php $width = $slider['properties']['width'] ?: 600;?>
					...
					<tr>
						<td>Slider height</td>
						<?php $height = $slider['properties']['height'] ?: 600;?>
					...
					<tr>
						<td>Responsive</td>						
						<?php $responsiveness = $slider['properties']['responsiveness'] ?: true;?>
						<td><input type="checkbox" name="responsiveness" <?php if($responsiveness == true) echo(checked);?>></td>
					...
					<tr>
						<td>Max-Width</td>
						<?php $maxWidth = $slider['properties']['maxWidth'] ?: 600;?>
						<td><input type="text" name="maxWidth" value="<?= $maxWidth ?>"></td>
					...
					<tr>
						...
						<td><?php lsGetInputt('responsiveunder', $slider['properties']['responsiveunder'], 0); ?></td>
					...
					<tr><th colspan="3"><?php _e('Other', 'LayerSlider') ?></th></tr>
					<tr>
