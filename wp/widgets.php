...
class LayerSlider_Widget extends WP_Widget {
	...
	function LayerSlider_Widget() {
		...
		$widget_ops = array( 'classname' => 'layerslider_widget', 'description' => 'Insert a slider');
		$control_ops = array( 'id_base' => 'layerslider_widget' );
		$this->WP_Widget( 'layerslider_widget', 'Slider WP Widget', $widget_ops, $control_ops );
	}
